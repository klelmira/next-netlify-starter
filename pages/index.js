...
.result button.show-correct-ones {
  left: 168px;
  padding: 5px;
}
...
.wrong-questions .answers-container span.explanation {
  color: #0dcc0d;
}

.wrong-questions .answers-container span.explanation:after {
  content: "explanation";
  right: -52px;
}
...
.correct-questions.active {
  top: 50%;
  left: 50%;
  transform: translateY(-50%) translateX(-50%);
}

.correct-questions::-webkit-scrollbar-track {
	border-radius: 10px;
}

.correct-questions::-webkit-scrollbar {
	width: 4px;
}

.correct-questions::-webkit-scrollbar-thumb {
	border-radius: 10px;
	background-color: #e6e6e6;
}

.correct-questions h2 {
  font-weight: 100;
  margin: 10px 0;
  text-align: center;
  color: #d21d0f;
...
.correct-questions .correct-one h3 {
  font-weight: 100;
}

.correct-questions .answers-container {
  padding-right: 40px;
}

.correct-questions .answers-container span {
  display: block;
  padding: 0 7px;
  position: relative;
}

.correct-questions .answers-container span:after {
  position: absolute;
  top: 0px;
  right: -40px;
  font-weight: 100;
...
.correct-questions .answers-container span.selected {
  color: #d21d0f;
}

.correct-questions .answers-container span.selected:after {
  content: "Yours";
}

.correct-questions .answers-container span.correct {
  color: #0dcc0d;
}

.correct-questions .answers-container span.correct:after {
  content: "Correct";
  right: -52px;
}

.correct-questions .answers-container span.explanation {
  color: #0dcc0d;
}

.correct-questions .answers-container span.explanation:after {
  content: "explanation";
  right: -52px;
}
...
.correct-questions button:hover {
  box-shadow: 4px 6px 15px 1px #ddd;
}
...
<br><br><br><br><br>
<p>
      <button class="show-correct-ones"
              v-show="correctAnswers > 0"
              @click="showCorrectQuestion = true">Correct answers</button>
</p>
   ...
   <div class="wrong-questions">
     ...
     <div class="wrong-one" v-for="question in wrongQuestions">
       ...
       <div class="answers-container">
         ...
         <span class="explanation">{{ question.answers[question.explanation] }}</span>
<br><br><br><br><br><br><br><br><br><br>
   ...
   <div class="correct-questions">
     <h2 v-if="correctQuestions.length > 1">Your correct Questions</h2>
     <h2 v-else-if="correctQuestions.length == 1">Your correct Question</h2>
     <div class="correct-one" v-for="question in correctQuestions">
       <h3>{{ question.question }}</h3>
       <div class="answers-container">
         <span class="selected">{{ question.answers[question.selected] }}</span>
         <span class="correct">{{ question.answers[question.correct_answer] }}</span>
...
<br><br><br><br><br><br><br><br><br><br>		 
     ...
     <button id="return-to-result2">Show my result</button>	 
   </div>
...
<script>
/* https://cdnjs.cloudflare.com/ajax/libs/vue/2.5.17-beta.0/vue.js */
/*!
...
new Vue({ 
  ...
  mounted() {
    ...
    var nextBtn = this.$el.querySelector('.next-btn'),
        ...
        correctAnswersBtn = this.$el.querySelector('.show-correct-ones'),		
        ...
        correctQuestions = this.$el.querySelector('.correct-questions'),
        showMyResults = this.$el.querySelector('#return-to-result');
        showMyResults2 = this.$el.querySelector('#return-to-result2');
      ...
      if(!nextBtn.hasAttribute('disabled') && this.currentQuestion < (questionsLength -1)) {    
        ...
        this.questions.forEach( (question) => {
          if(question.selected == question.correct_answer && question.sense ==0) {
			...
			temp.explanation = question.explanation;
            temp.selected = question.selected;			
			
            this.correctQuestions.push(temp);			
    ...
    correctAnswersBtn.addEventListener('click', () => {      
      result.classList.remove('active');
      correctQuestions.classList.add('active');
    });
    ...
    showMyResults2.addEventListener('click', () => {
      result.classList.add('active');
      correctQuestions.classList.remove('active');
    })
